...
echo ""
echo "========================================================="
echo " Step 0: Confirm your local username"
echo "========================================================="
DETECTED_USER=$(whoami)
echo "  Detected username : $DETECTED_USER"
echo "  Environments      : WSL (e.g. huan_y), macOS/Linux (e.g. john)"
echo ""
read -rp "  Enter your local username [press Enter to use '$DETECTED_USER']: " INPUT_USER
...
ok "Local username : $LOCAL_USER"
ok "Home directory : $LOCAL_HOME"
